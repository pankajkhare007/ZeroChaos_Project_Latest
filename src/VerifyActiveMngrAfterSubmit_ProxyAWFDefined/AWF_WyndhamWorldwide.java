package VerifyActiveMngrAfterSubmit_ProxyAWFDefined;
...
public class AWF_WyndhamWorldwide extends WebDriverHelper
{
	
	ResultSet rs;
	@Test(priority =1)
	public void setApprovalWorkFlowWyndhamWorldwide()throws Throwable
	{
