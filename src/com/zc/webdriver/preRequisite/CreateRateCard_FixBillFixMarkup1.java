...
public class CreateRateCard_FixBillFixMarkup1 extends WebDriverHelper{

	ResultSet rs;
	@Test
	public void createRateCardFBFM1ForPearson()throws Throwable
	{
		//Set Initial Work order , Amended Offer Letter and Pepco Holdings-Beeline as per division
			...
			Division.addNewRateCardForFixBillFixMarkup(rs, "30", "25");
