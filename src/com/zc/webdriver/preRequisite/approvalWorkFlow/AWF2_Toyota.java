...
public class AWF2_Toyota extends WebDriverHelper
{
	
	ResultSet rs;
	@Test(priority =1)
	public void setAWF2ForToyota()throws Throwable
	{
		...
		//Division.addApprovalGroupName("TRC GM");
		//Division.addContactToApprovalGroup("TRC GM", rs);
