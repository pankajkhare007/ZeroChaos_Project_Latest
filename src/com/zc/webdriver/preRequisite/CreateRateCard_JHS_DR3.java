...
public class CreateRateCard_JHS_DR3 extends WebDriverHelper{

	ResultSet rs;
	@Test
	public void createRateCardDR3ForPearsonInc()throws Throwable
	{
		//Set Initial Work order , Amended Offer Letter and Pepco Holdings-Beeline as per division
			...
			Division.addNewRateCard(rs,"ON","OFF");
			Common.logout();
