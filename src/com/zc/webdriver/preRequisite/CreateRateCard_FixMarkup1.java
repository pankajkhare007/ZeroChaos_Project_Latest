...
public class CreateRateCard_FixMarkup1 extends WebDriverHelper{

	ResultSet rs;
	@Test
	public void createRateCardFM1ForPearson()throws Throwable
	{
		//Set Initial Work order , Amended Offer Letter and Pepco Holdings-Beeline as per division
			...
			Division.addNewRateCardForFixMarkup(rs,"OFF");
