...
public class CreateRateCard_JHS_DR1 extends WebDriverHelper{

	ResultSet rs;
	@Test
	public void createRateCardDR1ForJacksonHealthSystem()throws Throwable
	{
		//Set Initial Work order , Amended Offer Letter and Pepco Holdings-Beeline as per division
			...
			Division.addNewRateCard(rs,"ON","ON");
			Common.logout();
