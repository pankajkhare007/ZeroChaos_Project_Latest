...
public class CreateRateCard_FixBillMaxMarkup2 extends WebDriverHelper{

	ResultSet rs;
	@Test
	public void createRateCardFBMM2ForPearson()throws Throwable
	{
		//Set Initial Work order , Amended Offer Letter and Pepco Holdings-Beeline as per division
			...
			Division.addNewRateCardForFixBillMaxMarkup(rs, "ON", "30");;
