...
public class ProjectConfiguration_DECA0038 extends WebDriverHelper{
	...
	public void projectAndContractSetting()throws Throwable
	{
		//Set Initial Work order , Amended Offer Letter and Pepco Holdings-Beeline as per division
			...
			Project.setProjectLocationCodeOnProjectDetail();
			...
			Project.inactivePayCodeUpdateFromDB("Sick");
