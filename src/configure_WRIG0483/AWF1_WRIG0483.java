...
public class AWF1_WRIG0483 extends WebDriverHelper
{
	...
	public void setApprovalWorkFlowForWRIG0483()throws Throwable
	{
		...
		Division.addApprovalGroupName("Primary Owner1");
		handleLoadingImage();
		Common.verifySuccessMessage("Approval group has been added successfully.");
		Division.addContactToApprovalGroupForDarel("Primary Owner1", rs);
