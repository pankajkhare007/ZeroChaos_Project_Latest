...
public class AddAaronAdsitInApprovalGroup extends WebDriverHelper {
	ResultSet rs;
	@Test(priority =1)
	public void addContactApprovalGroup()throws Throwable
	{
		...
		handleLoadingImage();
		WebControls.setValuesForWebObjects("WebList", division, "ContactApprovalGroup_ApproverNameDDL", "Aaron Adsit (Aaron.Adsit@wyndhamvo.com)");
		
		WebControls.setValuesForWebObjects("WebList", division, "ContactApprovalGroup_ItemTypeDDL", "Approval Item");
		
		WebControls.setValuesForWebObjects("WebEdit", division, "ContactApprovalGroup_FlowOrderTxt", "03");
