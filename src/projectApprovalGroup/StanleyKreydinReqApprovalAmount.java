...
public class StanleyKreydinReqApprovalAmount extends WebDriverHelper
{
	...
	public void setReqApprovalAmount()throws Throwable
	{
		...
		Common.quickSearch("Customer Contacts", "stan.kreydin@wyn.com");
		handleLoadingImage();
		WebControls.setValuesForWebObjects("WebList", division, "CreateUpdateContacts_ReportGroupDDL","Hiring Manager MSP");
		
		WebControls.setValuesForWebObjects("WebEdit", division, "Create_UpdateContact_txtReqApprovalAmount","2000");
